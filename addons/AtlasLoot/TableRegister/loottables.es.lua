...
--[[
  ...
  --Maraudon
    AtlasLoot_TableNames["MaraKhanKolk"][1] = "Kolk (El primer Khan)";
    AtlasLoot_TableNames["MaraKhanGelk"][1] = "Gelk (El segundo Khan)";
    AtlasLoot_TableNames["MaraKhanMagra"][1] = "Magra (El tercer Khan)";
    AtlasLoot_TableNames["MaraKhanVeng"][1] = "Veng (El quinto Khan)";
